...
urlpatterns = [
    ...
    path('admin_panel/create_exam_amount/', admin_views.create_exam_amount, name='create_exam_amount'),
    path('admin_panel/create_exam/<int:test_amount>', admin_views.create_exam, name='create_exam'),
